...
![R major versions](images/r_major_plot.png)
...
![R minor versions](images/r_minor_plot.png)

# What months have typically had the most patch updates?

We can look at the total number of patch_updates that have occurred in each month. We're currently in August 2023, so this might suggest when we can expect patch_updates to occur for the latest R version.

```{r patch-update-months, fig.height=5, fig.width=7}
release_dates %>% 
  mutate(
...
![R release months](images/release_months_plot.png)
